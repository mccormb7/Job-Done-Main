...
public class EditProfile {
  ...
  public void testEditProfile() throws Exception {
    ...
    new Select(driver.findElement(By.id("form-role"))).selectByVisibleText("Plumber");
    new Select(driver.findElement(By.id("form-role"))).selectByVisibleText("Painter");
    driver.findElement(By.id("form-title")).click();
    driver.findElement(By.id("form-title")).clear();
    driver.findElement(By.id("form-title")).sendKeys("Experienced Painter for Projects");
