...
public class EditPlan {
  ...
  public void testEditPlan() throws Exception {
    ...
    driver.findElement(By.xpath("(//a[contains(text(),'Edit')])[55]")).click();
    driver.findElement(By.id("form-description")).clear();
    driver.findElement(By.id("form-description")).sendKeys("My name is joe");
    new Select(driver.findElement(By.id("form-role"))).selectByVisibleText("Grinds");
