...
public class LoginOutProvider {
  ...
  @Test
  public void testLoginOutProvider() throws Exception {
    driver.get(baseUrl + "/spring/loggedout");
    driver.findElement(By.linkText("Log In")).click();
    driver.findElement(By.linkText("Login")).click();
    driver.findElement(By.id("form-username")).clear();
    driver.findElement(By.id("form-username")).sendKeys("tradeBill");
    driver.findElement(By.id("form-password")).clear();
    driver.findElement(By.id("form-password")).sendKeys("password");
    driver.findElement(By.cssSelector("form[name=\"f\"] > button[name=\"submit\"]")).click();
