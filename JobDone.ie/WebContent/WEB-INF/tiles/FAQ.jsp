		...
		<div class="panel-group" id="accordion">
			<div class="panel panel-primary">
				<div class="panel-heading">
					...
					<a data-toggle="collapse" data-parent="#accordion" href="#collapse2">What is Task Tackler?</a>
					</h4>
				</div>
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h4 class="panel-title">
					<a data-toggle="collapse" data-parent="#accordion" href="#collapse3">Benifit's of Task Tackler </a>
					</h4>
				</div>
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion" href="#collapse4">Client or Provider?</a>
					</h4>
				</div>
